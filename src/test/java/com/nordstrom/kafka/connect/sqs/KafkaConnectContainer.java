...
public class KafkaConnectContainer extends GenericContainer<KafkaConnectContainer> {
    ...
    private static final String IMAGE_NAME = "confluentinc/cp-kafka-connect:latest";
    ...
    public KafkaConnectContainer(String confluentPlatformVersion,
        ...
        this.withLogConsumer(containerLogsConsumer(Logger.getLogger(KafkaConnectContainer.class.getName())))
    ...
    public static Consumer<OutputFrame> containerLogsConsumer(Logger log) {
        return (OutputFrame outputFrame) -> log.info(outputFrame.getUtf8String());
    }
}
